...
//    @Value("classpath:inputs/products.csv")
    ...
    @Test
    public void test_integration__send_single_message() throws Exception {

        log.info(LINE);

        // Send messages...

        inputChannel.send(new GenericMessage<String>("Foo Bar"));
        ...
        assertThat(title.getPayload()).contains("Echo: [Foo Bar]");
